      ...
      <div className="container">
        ...
        <div className="hero__meta">
          <div className="hero__stat">
            <span className="hero__stat-value">~161K</span>
            <span className="hero__stat-label">lines of code</span>
          </div>
          <div className="hero__stat-sep" />
          <div className="hero__stat">
            <span className="hero__stat-value">7</span>
            <span className="hero__stat-label">production tools</span>
          </div>
          <div className="hero__stat-sep" />
          <div className="hero__stat">
            <span className="hero__stat-value">~10 wks</span>
            <span className="hero__stat-label">to ship all of them</span>
          </div>
        </div>

          ...
          {view === '3d' && product.model3d ? (
            <ViewerBoundary fallback={
              ...
              <Suspense fallback={
                ...
                <Model3DViewer parts={product.model3d.parts} color={product.model3d.color} rotationX={product.model3d.rotationX} />
              </Suspense>
            </ViewerBoundary>
          ) : allImages.length > 0 ? (
            <>
        ...
        {product.model3d ? (
          <ViewerBoundary fallback={
            ...
            <Suspense fallback={<div className="sp-card__placeholder"><div className="mv-spinner" /></div>}>
              <Model3DViewer mini parts={product.model3d.parts} color={product.model3d.color} rotationX={product.model3d.rotationX} />
            </Suspense>
          </ViewerBoundary>
        ) : product.image ? (
          <img src={product.image} alt={product.name} />
